...
const productValidation = async (req, res, next) => {
  ...
  return response.failedWithMessage("Product is not found !", req, res);
};
...
const usernameActevValidation = async (req, res, next, modelName) => {
  ...
  if (!username || username?.id == req.user.id) {
    next();
  } else return response.failedWithMessage("Username used bifor !", req, res);
};

const emailActevValidation = async (req, res, next, modelName) => {
  ...
  if (!email || email?.id == req.user.id) {
    next();
  } else return response.failedWithMessage("Email used bifor !", req, res);
};
